			...
			<div class="mx_stripe_window">	
				...
				<div class="mx_payment_method_switcher">
					...
					<div class="mx_payment_method_switch_card mx_payment_method_active">
						<svg class="SVGInline-svg SVGInline--cleaned-svg SVG-svg Icon-svg Icon--card-svg SVG--color-svg SVG--color--gray600-svg" style="width: 30px;height: 18px;" height="16" viewBox="0 0 16 16" width="16" xmlns="http://www.w3.org/2000/svg"><path d="M16 4H0v-.75C0 2.56.448 2 1 2h14c.552 0 1 .56 1 1.25zm0 2.5V13a1 1 0 0 1-1 1H1a1 1 0 0 1-1-1V6.5zM4 10a1 1 0 0 0 0 2h1a1 1 0 0 0 0-2z" fill-rule="evenodd"></path></svg>
					...
					<?php if( mxcpfc_get_payment_options()['enable_iban'] == 1 ) : ?>
						...
						<div class="mx_payment_method_switch_iban">
							<svg class="SVGInline-svg SVGInline--cleaned-svg SVG-svg Icon-svg Icon--bank-svg SVG--color-svg SVG--color--gray600-svg" style="width: 30px;height: 18px;" height="16" viewBox="0 0 16 16" width="16" xmlns="http://www.w3.org/2000/svg"><path d="M1.02 6A1 1 0 0 1 .5 4.134C.82 3.95 3.32 2.572 8 0c4.681 2.572 7.181 3.95 7.5 4.134A1 1 0 0 1 14.98 6zM11 14V7.5h3V14h1a1 1 0 0 1 1 1v1H0v-1a1 1 0 0 1 1-1h1V7.5h3V14h1.5V7.5h3V14z" fill-rule="evenodd"></path></svg>
